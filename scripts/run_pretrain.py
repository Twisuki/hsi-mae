...
def parse_args() -> argparse.Namespace:
    ...
    # Data
    parser.add_argument(
        "--data-path", type=str, required=True, help="Path to HSI .npy or .mat file"
    )
    parser.add_argument(
        "--labels-path", type=str, default=None, help="Path to labels file (optional)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of spectral bands (auto-detected from data if not set)",
    )
